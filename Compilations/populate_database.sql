...
(1, 1, 1, 1, 1, N'101', 8, CAST(DATEADD(day, 7, GETDATE()) AS Date), CAST(50.00 AS Decimal(10, 4)), 1),
(2, 1, 1, 2, 1, N'102', 12, CAST(DATEADD(day, 5, GETDATE()) AS Date), CAST(300.00 AS Decimal(10, 4)), 1),
(3, 2, 1, 3, 2, N'201', 6, CAST(DATEADD(day, 7, GETDATE()) AS Date), CAST(800.00 AS Decimal(10, 4)), 2),
(4, 3, 1, 1, 3, N'301', 10, CAST(DATEADD(day, 7, GETDATE()) AS Date), CAST(75.00 AS Decimal(10, 4)), 3),
(5, 4, 1, 2, 4, N'401', 15, CAST(DATEADD(day, 5, GETDATE()) AS Date), CAST(450.00 AS Decimal(10, 4)), 4),

-- Private office rooms
(6, 5, 2, 3, 5, N'501', 4, CAST(DATEADD(day, 6, GETDATE()) AS Date), CAST(1200.00 AS Decimal(10, 4)), 5),
(7, 6, 2, 1, 6, N'601', 6, CAST(DATEADD(day, 2, GETDATE()) AS Date), CAST(150.00 AS Decimal(10, 4)), 6),
(8, 7, 2, 2, 7, N'701', 8, CAST(DATEADD(day, 7, GETDATE()) AS Date), CAST(900.00 AS Decimal(10, 4)), 7),
(9, 8, 2, 3, 8, N'801', 10, CAST(DATEADD(day, 4, GETDATE()) AS Date), CAST(1500.00 AS Decimal(10, 4)), 8),
(10, 9, 2, 1, 9, N'901', 12, CAST(DATEADD(day, 6, GETDATE()) AS Date), CAST(200.00 AS Decimal(10, 4)), 9),

-- Desks
(11, 10, 3, 2, 10, N'1001', 1, CAST(DATEADD(day, 3, GETDATE()) AS Date), CAST(350.00 AS Decimal(10, 4)), 10),
(12, 11, 3, 3, 11, N'1101', 1, CAST(DATEADD(day, 4, GETDATE()) AS Date), CAST(1000.00 AS Decimal(10, 4)), 11),
(13, 12, 3, 1, 12, N'1201', 1, CAST(DATEADD(day, 7, GETDATE()) AS Date), CAST(50.00 AS Decimal(10, 4)), 12),
(14, 13, 3, 2, 13, N'1301', 1, CAST(DATEADD(day, 7, GETDATE()) AS Date), CAST(400.00 AS Decimal(10, 4)), 13),
(15, 14, 3, 3, 14, N'1401', 1, CAST(DATEADD(day, 2, GETDATE()) AS Date), CAST(1200.00 AS Decimal(10, 4)), 14),

-- Additional workspaces for testing
(16, 15, 1, 1, 15, N'1501', 8, CAST(DATEADD(day, 1, GETDATE()) AS Date), CAST(60.00 AS Decimal(10, 4)), 15),
(17, 16, 2, 2, 16, N'1601', 6, CAST(DATEADD(day, 3, GETDATE()) AS Date), CAST(950.00 AS Decimal(10, 4)), 1),
(18, 17, 3, 3, 17, N'1701', 1, CAST(DATEADD(day, 5, GETDATE()) AS Date), CAST(1100.00 AS Decimal(10, 4)), 2),
(19, 18, 1, 1, 18, N'1801', 10, CAST(DATEADD(day, 5, GETDATE()) AS Date), CAST(80.00 AS Decimal(10, 4)), 3),
(20, 19, 2, 2, 19, N'1901', 8, CAST(DATEADD(day, 7, GETDATE()) AS Date), CAST(850.00 AS Decimal(10, 4)), 4),
(21, 20, 3, 3, 20, N'2001', 1, CAST(DATEADD(day, 1, GETDATE()) AS Date), CAST(1300.00 AS Decimal(10, 4)), 5),
(22, 1, 1, 1, 21, N'2101', 12, CAST(DATEADD(day, 6, GETDATE()) AS Date), CAST(90.00 AS Decimal(10, 4)), 6),
(23, 2, 2, 2, 22, N'2201', 4, CAST(DATEADD(day, 2, GETDATE()) AS Date), CAST(1000.00 AS Decimal(10, 4)), 7),
(24, 3, 3, 3, 23, N'2301', 1, CAST(DATEADD(day, 4, GETDATE()) AS Date), CAST(1400.00 AS Decimal(10, 4)), 8),
(25, 4, 1, 1, 24, N'2401', 6, CAST(DATEADD(day, 6, GETDATE()) AS Date), CAST(70.00 AS Decimal(10, 4)), 9),
(26, 5, 2, 2, 25, N'2501', 10, CAST(DATEADD(day, 3, GETDATE()) AS Date), CAST(1100.00 AS Decimal(10, 4)), 10),
(27, 6, 3, 3, 26, N'2601', 1, CAST(DATEADD(day, 4, GETDATE()) AS Date), CAST(1500.00 AS Decimal(10, 4)), 11),
(28, 7, 1, 1, 27, N'2701', 8, CAST(DATEADD(day, 7, GETDATE()) AS Date), CAST(85.00 AS Decimal(10, 4)), 12),
(29, 8, 2, 2, 28, N'2801', 6, CAST(DATEADD(day, 7, GETDATE()) AS Date), CAST(950.00 AS Decimal(10, 4)), 13),
(30, 9, 3, 3, 29, N'2901', 1, CAST(DATEADD(day, 2, GETDATE()) AS Date), CAST(1600.00 AS Decimal(10, 4)), 14)
